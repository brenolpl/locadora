                        ...
                        <tbody>
                            <tr v-for="(ator, i) in entities" :key="i" :id="ator.id" :table="'ator'" >
                                ...
                                <td class="col-sm-3 text-center">
                                    <a href="javascript:void(0);" class="text-success" @click="adicionarAtor(ator)" :id="'addButton-'+ator.id">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2Z"/>
                                        </svg>
                                    </a>
                                    <a href="javascript:void(0);" class="text-danger d-none" @click="removerAtor(ator)" :id="'rmvButton-'+ator.id">
...
export default defineComponent({
    ...
    setup(props,{emit}) {
        ...
        const { erros, save, entities, getAll } = useRequests(Ator);
